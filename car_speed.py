        ...
        for i in carLocation1.keys():
            if frameCounter % 1 == 0:
                ...
                if [x1, y1, w1, h1] != [x2, y2, w2, h2]:
                    ...
                    if speed[i]!= None and speed[i] >= 55 and y1 > 180:
                        cv2.putText(resultImage, str(int(speed[i])) + "km/h , OverSpeed", (int(x1 + w1 / 2), int(y1 - 5)),
                                    cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 100), 2)
                    if speed[i] != None and speed[i] >= 55 and y1 > 180:
                        cv2.rectangle(resultImage, (t_x, t_y), (t_x + t_w, t_y + t_h), (0,0,100), 4)
